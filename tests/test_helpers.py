...
from arch_javid_installer.helpers import get_keyboard_layouts
...
class TestKeyboardHelpers:
    ...
    def test_get_keyboard_layouts(self) -> None:
        """Test the get_keyboard_layouts function."""
        mock_models = [
        ...
        models, layouts, variants = get_keyboard_layouts(mock_layouts_file_content)
